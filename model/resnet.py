...
def resnet101_features(pretrained=False, model_dir=None, return_classifier_w= False, **kwargs):
    ...
    if pretrained:
        ...
        classifier_w = my_dict['fc.weight']
        my_dict.pop('fc.weight')
        my_dict.pop('fc.bias')
        model.load_state_dict(my_dict, strict=False)

    if return_classifier_w:
        return model, classifier_w
    else:
        return model
